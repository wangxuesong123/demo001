...
public class UserController {
	...
	@PostMapping("/user")
	public String create(@ApiParam("用户账号") @RequestParam(value = "uid") String uid,@RequestParam(value = "displayName") String displayName,@RequestParam(value = "mail") String mail) {
